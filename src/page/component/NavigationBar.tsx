    ...
    return (
        <div className='w-full h-full flex px-[60px] items-center shadow-md'>
            ...
            <div>
                ...
                <Link className={`mx-[30px] text-[18px] font-medium ${location.pathname === '/company/home' ? 'underline underline-offset-8' : ''}`} to={'/company/home'}>Company</Link>
                <Link className={`mx-[30px] text-[18px] font-medium ${location.pathname === '/company/vacancy' ? 'underline underline-offset-8' : ''}`} to={'/company/vacancy'}>Company Vacancy</Link>
            </div>
