        ...
        <Layout>
            <div className='mx-[20vw] pt-10 flex justify-center pb-20'>
                <div>
                    ...
                    <div className='mt-10'>
                        <div className='text-[24px] font-medium mb-2 font-semibold'>Job Recommendation</div>
                    ...
                    <div className='mt-10 w-full'>
                        <div className='text-[24px] font-medium mb-2 font-semibold'>Curriculum Vitae</div>
                        <div className='grid justify-between mt-6 w-full gap-10' style={{ gridTemplateColumns:'auto auto auto auto'}}>
                            <CVTemplate/>
                            <CVTemplate/>
                            <CVTemplate/>
                            <CVTemplate/>
